    ...
    <div className="bg-white py-12">
      <div className="container mx-auto px-4  lg:px-20">
        <div className="flex flex-col-reverse md:flex-row md:gap-24">
          <div className="max-w-[564px] md:ml-14 mt-6 ">
            <div className="space-y-4">
              <h2 className="text-center md:text-left text-2xl  lg:text-2xl font-semibold text-[#723A20]">
          ...
          <div className="lg:w-full mt-4 lg:mt-0 grid grid-cols-2 gap-4">
            ...
            <Image
              ...
              className="rounded-lg w-full"
            />
            <Image src={chemist} alt="Nurses" className="rounded-lg w-full " />
          </div>
        </div>
      </div>
    </div>
